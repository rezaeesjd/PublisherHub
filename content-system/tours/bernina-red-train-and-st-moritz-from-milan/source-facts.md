...
| website booking URL | not provided | User input | missing | |
...
| missing critical inputs | No Viator/TripAdvisor/Website permalink at intake | Derived | needs_human_review | Booking link must be supplied before public publish |
| conflicts detected | none | Derived | not_applicable | |

## Clarifications needed (blocking)

- Booking permalink: at least one real link (Viator, TripAdvisor, or supplier website) must be supplied before this package can drive a public CTA.
